    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        if(permissions == null){
            ...
            for (Permission p:permissions){
                if("POST".equals(method) && "updateRole".equals(p.getName())){
                    flag = true; break;
                }
                if("GET".equals(method) && "searchRole".equals(p.getName())){
                    flag = true; break;
                }
                if("DELETE".equals(method) && "deleteRole".equals(p.getName())){
                    flag = true; break;
                }
                if("PUT".equals(method) &&  "addRole".equals(p.getName())){
                    flag = true; break;
                }
            }
        }
